...
plot [0:0.7]     '< awk "(\$3==9){print \$0}" /tmp/interp' u (r($1,$2)):(e($5,$1,$2)) t 'level 9',      '< awk "(\$3==8){print \$0}" /tmp/interp' u (r($1,$2)):(e($5,$1,$2)) t 'level 8',      '< awk "(\$3==7){print \$0}" /tmp/interp' u (r($1,$2)):(e($5,$1,$2)) t 'level 7',      '< awk "(\$3==6){print \$0}" /tmp/interp' u (r($1,$2)):(e($5,$1,$2)) t 'level 6',      '< awk "(\$3==5){print \$0}" /tmp/interp' u (r($1,$2)):(e($5,$1,$2)) t 'level 5',      '< awk "(\$3==4){print \$0}" /tmp/interp' u (r($1,$2)):(e($5,$1,$2)) t 'level 4'
#    EOF
