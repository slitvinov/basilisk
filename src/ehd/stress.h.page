...
We need to add the corresponding acceleration to the Navier--Stokes
[solver](/src/navier-stokes/centered.h).
...
/**
We overload the [acceleration
event](/src/navier-stokes/centered.h##acceleration-term) of the
Navier--Stokes solver to add the electrohydrodynamics acceletation
term. */
...
event acceleration (i++) {
  ...
  /**
  If axisymmetric cylindrical coordinates are used an additional term
  has to be added. */
