...
written. Note that for configuration (a) to reach the stationary
situation requires just one iteration while for the rest of
configurations about 15 are required. */
