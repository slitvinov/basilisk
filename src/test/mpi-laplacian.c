...
int main (int argc, char * argv[])
{
  ...
  mpi_print (t, nloops, 0, "laplacian");
  ...
  while (i--)
    restriction ({b});
  mpi_print (t, nloops, 0, "restriction");
